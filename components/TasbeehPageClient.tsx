...
interface TasbeehPageClientProps {
  tasbeehs: Tasbeeh[];
}

function TasbeehPageContent({ tasbeehs }: TasbeehPageClientProps) {
...
export default function TasbeehPageClient({ tasbeehs }: TasbeehPageClientProps) {
  return (
    <Suspense
      fallback={
        <div
    ...
    >
      <TasbeehPageContent tasbeehs={tasbeehs} />
    </Suspense>
  );
}
